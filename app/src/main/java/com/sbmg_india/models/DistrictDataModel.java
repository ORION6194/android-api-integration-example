...
public class DistrictDataModel implements Parcelable{
    private int id;
    ...
    protected DistrictDataModel(Parcel in) {
        id = in.readInt();
        state_id = in.readInt();
    ...
    public static final Creator<DistrictDataModel> CREATOR = new Creator<DistrictDataModel>() {
        @Override
        public DistrictDataModel createFromParcel(Parcel in) {
            return new DistrictDataModel(in);
        }

        @Override
        public DistrictDataModel[] newArray(int size) {
            return new DistrictDataModel[size];
        }
    };
